...
#             "Exponential::backgroundFail(mass, cF[0.0, -1.0, 0.0])",
         ...
         pdfSignalPlusBackgroundb6 = cms.vstring(
             ...
             "FCONV::signalPass(mass, signalPassMC, signalPassSmear)",
             "FCONV::signalFail(mass, signalFailMC, signalFailSmear)",
             "RooCMSShape::backgroundPass(mass, alphaPass[140.,130.,155.], betaPass[0.02, 0.01, 0.04], gammaPass[0.1, 0, 0.2], peakPass[91.2, 90, 92])",
             "RooCMSShape::backgroundFail(mass, alphaFail[120.,115.,125.], betaFail[0.02, 0.001, 0.04], gammaFail[0.1, 0, 0.2], peakFail[91.2, 90, 92])",
            "efficiency[0.8,0,1]",
        ),
        ),
