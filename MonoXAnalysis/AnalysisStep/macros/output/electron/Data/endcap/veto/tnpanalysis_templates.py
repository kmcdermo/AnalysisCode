...
#             "Exponential::backgroundFail(mass, cF[0.0, -1.0, 0.0])",
         ...
         pdfSignalPlusBackgroundb0 = cms.vstring(
             ...
             "RooCMSShape::backgroundPass(mass, alphaPass[120.,70.,130.], betaPass[0.25, -0.5 ,0.5], gammaPass[0.04, -0.1, 0.1], peakPass[91.2, 90, 92])",
             "RooCMSShape::backgroundFail(mass, alphaFail[100.,70.,130.], betaFail[0.001, -0.1 ,0.1], gammaFail[0.04, -0.1, 0.1], peakFail[91.2, 90, 92])",
             "efficiency[0.8,0,1]"
        ),
         pdfSignalPlusBackgroundb1 = cms.vstring(
             ...
             "Gaussian::signalPassSmear(mass, mP[-0.8,  -1.5, 0.5], sp[1.5, 0.5, 3.0])",
             "Gaussian::signalFailSmear(mass, mF[-1.12, -1.5, 0.5], sF[2.0, 0.5, 3.0])",
             "FCONV::signalPass(mass, signalPassMC, signalPassSmear)",
             "FCONV::signalFail(mass, signalFailMC, signalFailSmear)",
             "RooCMSShape::backgroundPass(mass, alphaPass[78.,60.,90.], betaPass[0.06, 0.0, 0.5], gammaPass[0.074, -0.01, 0.1], peakPass[91.2, 90, 92])",
             "RooCMSShape::backgroundFail(mass, alphaFail[65.,50.,80.], betaFail[0.17, 0.0, 0.3], gammaFail[0.028, 0.01, 0.1], peakFail[91.2, 90, 92])",
             "efficiency[0.8,0,1]"
        ),
