...
#             "Exponential::backgroundFail(mass, cF[0.0, -1.0, 0.0])",
         ...
         pdfSignalPlusBackgroundb0 = cms.vstring(
             ...
             "Gaussian::signalPassSmear(mass, mP[0.16, -1.0, 1.0], sp[0.2, 0.0, 1.0])",
             "Gaussian::signalFailSmear(mass, mF[0.16, -1.0, 1.0], sF[0.2, 0.0, 1.0])",
         ...
         pdfSignalPlusBackgroundb4 = cms.vstring(
             ...
             "Gaussian::signalPassSmear(mass, mP[0.16, 0., 1.0], sp[0.25, 0.0, 1.0])",
             "Gaussian::signalFailSmear(mass, mF[0.20, 0., 1.0], sF[0.25, 0.0, 1.0])",
             "FCONV::signalPass(mass, signalPassMC, signalPassSmear)",
             "FCONV::signalFail(mass, signalFailMC, signalFailSmear)",
             "RooCMSShape::backgroundPass(mass, alphaPass[140.,120.,160.], betaPass[0.013, 0. ,0.1], gammaPass[0.01, 0, 0.1], peakPass[91.2, 90, 92])",
             "RooCMSShape::backgroundFail(mass, alphaFail[92., 85., 100.], betaFail[0.023, 0. ,0.1], gammaFail[0.01, 0, 0.1], peakFail[91.2, 90, 92])",
             "efficiency[0.8,0,1]",
        ),
         pdfSignalPlusBackgroundb5 = cms.vstring(
             "#import "+TemplateDir+"templates5.root:w:signalPassMC",
             "#import "+TemplateDir+"templates4.root:w:signalFailMC",
             "Gaussian::signalPassSmear(mass, mP[0.16, 0.0, 1.0], sp[0.4, 0.0, 1.0])",
             "Gaussian::signalFailSmear(mass, mF[0.40, 0.0, 1.0], sF[1.0, 0.0, 2.0])",
             "FCONV::signalPass(mass, signalPassMC, signalPassSmear)",
             "FCONV::signalFail(mass, signalFailMC, signalFailSmear)",
             "RooCMSShape::backgroundPass(mass, alphaPass[140.,120.,160.], betaPass[0.013, 0. ,0.1], gammaPass[0.005, 0, 0.1], peakPass[91.2, 90, 92])",
             "RooCMSShape::backgroundFail(mass, alphaFail[91., 80., 100.], betaFail[0.023, 0. ,0.1], gammaFail[0.015, 0, 0.1], peakFail[91.2, 90, 92])",
             "efficiency[0.8,0,1]",
        ),
         pdfSignalPlusBackgroundb6 = cms.vstring(
             "#import "+TemplateDir+"templates5.root:w:signalPassMC",
             "#import "+TemplateDir+"templates5.root:w:signalFailMC",
             "Gaussian::signalPassSmear(mass, mP[0.16, -1.0, 1.0], sp[1.0, 0.0, 2.0])",
             "Gaussian::signalFailSmear(mass, mF[0.16, -1.0, 1.0], sF[1.5, 0.0, 3.0])",
             "FCONV::signalPass(mass, signalPassMC, signalPassSmear)",
             "FCONV::signalFail(mass, signalFailMC, signalFailSmear)",
             "RooCMSShape::backgroundPass(mass, alphaPass[140.,120.,160.], betaPass[0.01, 0. ,0.1], gammaPass[0.033, 0, 0.1], peakPass[91.2, 90, 92])",
             "RooCMSShape::backgroundFail(mass, alphaFail[160.,140.,180.], betaFail[0.01, 0. ,0.1], gammaFail[0.033, 0, 0.1], peakFail[91.2, 90, 92])",
             "efficiency[0.8,0,1]",
        ),
        ),
