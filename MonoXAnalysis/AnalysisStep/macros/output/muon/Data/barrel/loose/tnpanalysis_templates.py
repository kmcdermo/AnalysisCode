...
#             "Exponential::backgroundFail(mass, cF[0.0, -1.0, 0.0])",
         ...
         pdfSignalPlusBackgroundb0 = cms.vstring(
             ...
             "RooCMSShape::backgroundPass(mass, alphaPass[106.,100.,110.], betaPass[0.105, -0.5 ,0.5], gammaPass[0.05, 0, 0.1], peakPass[91.2, 90, 92])",
             "RooCMSShape::backgroundFail(mass, alphaFail[120.,100.,150.], betaFail[0.105, 0. ,0.5], gammaFail[0.033, 0, 0.1], peakFail[91.2, 90, 92])",
             "efficiency[0.8,0,1]"
        ),
          pdfSignalPlusBackgroundb1 = cms.vstring(
             ...
             "Gaussian::signalPassSmear(mass, mP[0.2, -2, 2.], sp[0.3, 0.0, 2.0])",
             "Gaussian::signalFailSmear(mass, mF[0.2, -2, 2.], sF[0.3, 0.0, 2.0])",
             "FCONV::signalPass(mass, signalPassMC, signalPassSmear)",
             "FCONV::signalFail(mass, signalFailMC, signalFailSmear)",
             "RooCMSShape::backgroundPass(mass, alphaPass[50.,20.,150.], betaPass[0.01, 0., 0.1], gammaPass[0.064, 0, 0.1], peakPass[91.2, 90, 92])",
             "RooCMSShape::backgroundFail(mass, alphaFail[50.,20.,150.], betaFail[0.01, -1.0, 1.0], gammaFail[0.025, 0, 0.1], peakFail[91.2, 90, 92])",
             "efficiency[0.8,0,1]"
        ),
         pdfSignalPlusBackgroundb2 = cms.vstring(
             ...
             "FCONV::signalPass(mass, signalPassMC, signalPassSmear)",
             "FCONV::signalFail(mass, signalFailMC, signalFailSmear)",
             "RooCMSShape::backgroundPass(mass, alphaPass[100.,50.,150.], betaPass[0.01, -1.0, 1.0], gammaPass[0.064, 0, 0.1], peakPass[91.2, 90, 92])",
             "RooCMSShape::backgroundFail(mass, alphaFail[100.,50.,150.], betaFail[0.01, -1.0, 1.0], gammaFail[0.025, 0, 0.1], peakFail[91.2, 90, 92])",
             "efficiency[0.8,0,1]"
         ...
         pdfSignalPlusBackgroundb3 = cms.vstring(
             ...
             "FCONV::signalPass(mass, signalPassMC, signalPassSmear)",
             "FCONV::signalFail(mass, signalFailMC, signalFailSmear)",
             "RooCMSShape::backgroundPass(mass, alphaPass[100.,80.,120.], betaPass[0.01, -1.0, 1.0], gammaPass[0.1, 0, 0.3], peakPass[91.2, 90, 92])",
             "RooCMSShape::backgroundFail(mass, alphaFail[0.1, 0.,10.], betaFail[0.01, -1.0, 1.0], gammaFail[0.01, 0, 0.1], peakFail[91.2, 90, 92])",
             "efficiency[0.8,0,1]"
         ),
         pdfSignalPlusBackgroundb4 = cms.vstring(
             ...
             "FCONV::signalFail(mass, signalFailMC, signalFailSmear)",
             "RooCMSShape::backgroundPass(mass, alphaPass[100.,80.,120.], betaPass[0.01, -1.0, 1.0], gammaPass[0.1, 0, 0.3], peakPass[91.2, 90, 92])",
             "RooCMSShape::backgroundFail(mass, alphaFail[0.1, 0., 50.], betaFail[0.01, -1.0, 1.0], gammaFail[0.01, 0, 0.1], peakFail[91.2, 90, 92])",
             "efficiency[0.8,0,1]"
        ),
